...
- Vitest is intentionally capped at `1` worker in [`/Users/dannytrevino/development/magic-agents/ui/vitest.config.ts`](/Users/dannytrevino/development/magic-agents/ui/vitest.config.ts) because the jsdom-heavy UI suite can starve and trip false timeouts under concurrent worker contention even when the same files pass in isolation.
