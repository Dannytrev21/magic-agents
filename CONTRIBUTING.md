...
- Preserve the named workspace status and announcement regions, tabpanel wiring, and focus handoff rules when changing shell or workspace navigation behavior.
- Keep reduced-motion handling CSS-first; new motion should degrade to a no-frills equivalent under `prefers-reduced-motion`.
...
- Treat the snapshot and axe-backed accessibility tests as release gates for shell, negotiation, and verification changes; update snapshots only when the DOM change is intentional.
...
- Record durable UI architecture decisions in [`/Users/dannytrevino/development/magic-agents/docs/adr/0001-workspace-inspector.md`](/Users/dannytrevino/development/magic-agents/docs/adr/0001-workspace-inspector.md), [`/Users/dannytrevino/development/magic-agents/docs/adr/0002-verification-console.md`](/Users/dannytrevino/development/magic-agents/docs/adr/0002-verification-console.md), or later ADRs when the decision scope expands.
