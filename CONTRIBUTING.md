...
- In Playwright flows that advance negotiation phases, wait for the phase action button to be enabled before clicking again. Header copy can advance before the next approval or revision control is actionable, and skipping that readiness check creates false browser failures.
