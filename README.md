...
- The top bar now consumes live SSE connection state through [`/Users/dannytrevino/development/magic-agents/ui/src/features/workspace/phaseWorkspaceModel.ts`](/Users/dannytrevino/development/magic-agents/ui/src/features/workspace/phaseWorkspaceModel.ts), showing a quiet stream-status pill beside the session pill while a thin phase progress strip can render under the chrome without blowing the existing shell CSS budget.
